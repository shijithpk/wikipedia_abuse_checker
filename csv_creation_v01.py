...
def create_csvs(compiled_stats_source_name, category, datetime_object):
	...
	df_culled_filepath = folder_path + '/pages_most_users_reverted_past_1_week.csv'
	...
	df_culled_filepath = folder_path + '/pages_most_users_reverted_past_1_month.csv'
	df_culled.to_csv(df_culled_filepath, index=False, encoding='utf-8')
	...
	df_culled_filepath = folder_path + '/pages_most_users_reverted_past_3_months.csv'
	df_culled.to_csv(df_culled_filepath, index=False, encoding='utf-8')
	...
	df_culled_filepath = folder_path + '/pages_most_users_reverted_delta_from_last_week.csv'
	df_culled.to_csv(df_culled_filepath, index=False, encoding='utf-8')
